...
* [Electoral Commision](https://www.electoralcommission.org.uk) : constituency-level result data.
...
View composition in `ggplot2` is not as easier and elegant as in [vega-lite](https://vega.github.io/vega-lite/), but I'm using `gridExtra::grid.arrange()` and some fiddly trial and error work.
